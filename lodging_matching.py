        ...
        cur.execute(
            ...
            SELECT lr.biz_name, lr.permit_number, lr.permit_date,
                   ...
                   lr.source_updated_at, lr.biz_name_norm, lr.road_norm, lr.jibun_norm,
                    lr.facility_area, lr.region_name, lr.western_rooms, lr.korean_rooms,
                    lr.toilet_count, lr.toilet_type, lr.breakfast_yn, lr.house_area,
                    lr.zone_type, lr.surroundings, lr.floors_above, lr.floors_below,
                    lr.camping_site_count,

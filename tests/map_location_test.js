...
expect(
  source.includes('"전남광주통합특별시": { lat: 34.900, lng: 125.450 }'),
  "전남광주통합특별시 시도 클러스터가 목포 서쪽 해상으로 보정되지 않았습니다.",
);
